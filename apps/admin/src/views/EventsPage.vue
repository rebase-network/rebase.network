    ...
    <template v-else>
      <section class="panel list-toolbar-panel">
        <div class="list-toolbar-row">
          ...
          <label class="list-toolbar-search" for="event-search">
        ...
        <table class="data-table dense-table">
            ...
            <tr>
              ...
              <th class="status-filter-column">
                <div ref="statusFilterRef" class="table-filter-menu">
                  ...
                  <div v-if="statusFilterOpen" class="table-filter-popover" role="menu" aria-label="按状态筛选活动">
                    <button
          ...
          <tbody>
            <tr v-if="rows.length === 0">
              <td class="table-empty-row" colspan="7">当前筛选条件下没有活动，请调整搜索或状态筛选。</td>
            </tr>

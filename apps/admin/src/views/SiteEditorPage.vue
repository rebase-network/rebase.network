      ...
      <aside class="stacked-gap editor-sidebar sticky-stack">
        ...
        <section class="panel stacked-gap">
          ...
          <dl class="summary-grid">
            ...
            <div class="summary-item">
              <dt>辅助域名</dt>
              <dd class="muted">{{ settings.secondaryDomain || '未填写' }}</dd>
            </div>
            <div class="summary-item">
              <dt>媒体域名</dt>
              <dd class="muted">{{ settings.mediaDomain || '未填写' }}</dd>
            </div>
            <div class="summary-item">
              <dt>首屏按钮</dt>
        ...
        <section class="panel stacked-gap">
          ...
          <div class="dashboard-guidance-list">
            ...
            <article class="insight-card">
              <strong>保存策略</strong>
              <p>三个板块统一由顶部“保存全部修改”提交，切换板块不会丢失当前输入。</p>
            </article>
          </div>
        </section>
      </aside>

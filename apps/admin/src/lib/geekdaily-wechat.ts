...
const renderWechatLead = () => `
  <p style="margin: 0 0 24px; color: #3d464d; font-size: 16px; line-height: 1.9; word-break: break-word;">
...
const renderWechatItem = (item: GeekDailyWechatItemInput) => `
  <div style="margin: 0 0 28px; padding: 18px 16px; border-radius: 12px; background: #f7f7f7;">
    <p style="margin: 0 0 18px; color: #111111; font-size: 18px; line-height: 1.7; font-weight: 700;">
      <strong>${escapeHtml(item.title.trim())}</strong>
    </p>
    <p style="margin: 0 0 18px; color: #747474; font-size: 15px; line-height: 1.8; word-break: break-all;">
...
const renderWechatFooter = () => `
  <div style="margin-top: 30px; padding-top: 24px; border-top: 1px solid #e9e9e9;">
...
function renderWechatTemplate(items: GeekDailyWechatItemInput[]) {
  return `
    <div style="margin: 0; color: #1f1f1f; font-size: 16px; line-height: 1.8;">
      ${renderWechatLead()}

...
export const siteSettings = pgTable('site_settings', {
  ...
  infoqUsername: text('infoq_username'),
  infoqPasswordEncrypted: text('infoq_password_encrypted'),
...
export const articles = pgTable(
  ...
  {
    id: uuid('id').defaultRandom().primaryKey(),
    publicNumber: serial('public_number').notNull(),
    ...
    seoTitle: text('seo_title'),
    seoDescription: text('seo_description'),
    infoqArticleUuid: text('infoq_article_uuid'),
    learnBlockchainArticleId: text('learnblockchain_article_id'),
  ...
  (table) => [uniqueIndex('articles_public_number_idx').on(table.publicNumber)],
);
...
export const jobs = pgTable(
  ...
  (table) => [uniqueIndex('jobs_public_number_idx').on(table.publicNumber)],
);
...
export const events = pgTable(
  ...
  (table) => [uniqueIndex('events_public_number_idx').on(table.publicNumber)],
);

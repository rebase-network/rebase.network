...
const defaultSiteUrl = 'https://rebase.network';
  ...
  return `
    ...
    <div class="rich_media_content" style="visibility: visible; margin: 5px 8px;">
      <h2 style="margin-bottom: 14px;font-size: 22px;line-height: 1.4;font-family: -apple-system-font, system-ui, &quot;Helvetica Neue&quot;, &quot;PingFang SC&quot;, &quot;Hiragino Sans GB&quot;, &quot;Microsoft YaHei UI&quot;, &quot;Microsoft YaHei&quot;, Arial, sans-serif;letter-spacing: 0.544px;text-align: start;white-space: normal;background-color: rgb(255, 255, 255);">
          ...
          ，方便阅读文中的链接，也可通过 ${escapeHtml(archiveUrl)} 浏览每期日报内容。</span></span></h2>
      ...
      <p style="max-width: 100%;min-height: 1em;text-align: center;box-sizing: border-box !important;overflow-wrap: break-word !important;"><span style="max-width: 100%;font-size: 15px;box-sizing: border-box !important;overflow-wrap: break-word !important;"><strong style="max-width: 100%;box-sizing: border-box !important;overflow-wrap: break-word !important;">网站:</strong><strong style="max-width: 100%;box-sizing: border-box !important;overflow-wrap: break-word !important;">${escapeHtml(siteUrl)}</strong></span></p>
